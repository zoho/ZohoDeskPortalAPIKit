...
# Swift Package for ZohoDeskPortalAPIKit iOS SDK
...
2. Add `https://github.com/zoho/ZohoDeskPortalAPIKit.git` as the package repository and click on **Next**.
3. Choose the latest release of the package under package options and click on **Next**.
4. Select ZohoDeskPortalAPIKit under Package Products and click on **Finish**
