...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "ZohoDeskPortalAPIKit", url: "https://maven.zohodl.com/ZohoDesk/ZohoDeskPortalAPIKit/\(version)/ZohoDeskPortalAPIKit.zip", checksum: "9fc25e1dd5d9c39a1666ae9600985d90aea078d28b5f1932e5c979be2918b3bb")
    ]
)
