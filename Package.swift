...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "ZohoDeskPortalAPIKit", url: "https://maven.zohodl.com/ZohoDesk/ZohoDeskPortalAPIKit/\(version)/ZohoDeskPortalAPIKit.zip", checksum: "3692265371169289771f9ad27cb4771eac7a8306bfc6d8043e2017cd1fa32909")
    ]
)
