...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "ZohoDeskPortalAPIKit", url: "https://maven.zohodl.com/ZohoDesk/ZohoDeskPortalAPIKit/\(version)/ZohoDeskPortalAPIKit.zip", checksum: "daec86ceeb0bae93909a019cf05b2ee3bbec4ceb49dd446f78faa98cca49a2bf")
    ]
)
